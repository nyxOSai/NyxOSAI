    ...
    async def call_func(self,func_name, args):
        match func_name:
            ...
            case 'exit':
                os._exit(0)
            case 'help':
                return FormattedText([("class:title", f"GO to https://github.com//nyxOSai/NyxOSAI/issues ^_^")])
...
\t//   |/ /         / /    / /\  ((___/ /     ((___ / /    //     | | __/ /___
    ...
    print("\033[1;32m \t\tWelcome to NyxOSAI - Your Personal AI OS\033[0m\n")

    introduce = """
\tNyxOSAI (Open and Do Anything Now with AI) is revolutionizing the 
...
\tinteroperability. NyxOSAI empowers users to craft powerful AI agents:
...
"""
    ...
    print("\033[1;33m \tNyxOSAI is an open-source project, let's define the future of Humans and AI together.\033[0m")
    print("\033[1;33m \tGithub\t: https://github.com//nyxOSai/NyxOSAI\033[0m")
    print("\033[1;33m \tWebsite\t: https://www.nyxos.ai\033[0m")
    print("\n\n")
